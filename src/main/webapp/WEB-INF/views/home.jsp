  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="<c:url value="/resources/images/bk17.jpg" />" alt="Chania"  >
      ...
      <div class="item">
        <img src="<c:url value="/resources/images/bk18.jpg" />" alt="Chania"  >
        <div class="carousel-caption">
          <h3>Best Selling</h3>
          <p>The atmosphere in Chania has a touch of Florence and Venice.</p>
        </div>
      ...
      <div class="item">
        <img src="<c:url value="/resources/images/bk19.jpg" />" alt="Flower"  >
        <div class="carousel-caption">
          <h3>New Entry</h3>
...
<!-- Adding extra content    <c:url value="/resources/images/2.jpg" />        -->
