...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            <h1><strong> Add the New Entry</strong></h1>
...
<form:form method="post" action="${url}" commandName="bookObj" enctype="multipart/form-data"  class="form-horizontal" >
...
<%-- 
<c:url value="/admin/book/addBook" var="url"></c:url>
<form:form method="post" action="${url}" commandName="bookObj" enctype="multipart/form-data" >
   <table class=""> 
     <tr>
     ...
     <td><form:errors path="publisher"></form:errors></td>
     </tr>
     <tr>
     ...
     <td>&nbsp <form:radiobutton path="category.cid" value="3"/> &nbspDISCOUNT </td>
     </tr>
